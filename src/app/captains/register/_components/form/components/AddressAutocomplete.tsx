...
interface AddressAutocompleteProps {
  ...
  error?: boolean;
  className?: string;
  minLength?: number; // minimum chars before querying
  debounceMs?: number;
}
...
export function AddressAutocomplete({
  ...
  // Persist a session token across keystrokes to improve billing grouping.
        ...
        >
          {suggestions.map((s, i) => (
            <li
              ...
              onMouseDown={(e) => {
                // prevent input blur before click handling
                e.preventDefault();
                selectIndex(i);
              }}
