...
import type { GoogleAddressComponent } from "../hooks/usePlaceDetails";
...
export function parseAddressComponents(
  ...
  // Map city within matched state (using existing district lists)
  ...
  return {
    state: matchedState,
    city: matchedCity || cityCandidate, // fall back to raw candidate if not in list
    postcode,
  };
}
