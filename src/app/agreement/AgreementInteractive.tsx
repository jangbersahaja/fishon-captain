...
const sections: SectionDef[] = [
  {
    ...
    content: (
      <p>
        These Terms and Conditions (&quot;Agreement&quot;) govern the registration and
        participation of Captains and Charter Operators (&quot;You&quot; or
        &quot;Operator&quot;) on the Fishon.my platform, owned and operated by Kartel
        Motion Venture (Business Registration No: 202203267096 (003441013-T))
        (&quot;We&quot;, &quot;Us&quot;, or &quot;Fishon&quot;). By registering as an Operator, you agree to
        comply with these terms, our platform policies, and all applicable
...
export default function AgreementInteractive() {
  const [openStates, setOpenStates] = useState<Record<string, boolean>>(() => {
    ...
    try {
      const raw = localStorage.getItem("fishon:agreement:collapse");
      if (raw) {
  ...
  useEffect(() => {
    const headings = Array.from(
      document.querySelectorAll<HTMLElement>("[data-agreement-heading]")
    );
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <h2
                      data-agreement-heading
                      data-agreement-heading-id={s.id}
          ...
          <ol className="list-decimal pl-5 space-y-2 text-sm">
            {sections.map((s, i) => (
              <li key={s.id}>
                ...
                >
                  <span className="font-medium tabular-nums mr-1">{i + 1}.</span>
                  {s.title}
                </a>
              </li>
            ))}
