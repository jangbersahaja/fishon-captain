-- Add captainId and ownerId to v_public_charters view for analytics tracking
-- This allows fishon-market to track which captain/owner a charter belongs to
...
SELECT 
    ...
    jsonb_build_object(
        ...
        -- Add ID fields for analytics tracking
